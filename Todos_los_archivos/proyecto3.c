...
/* 
Este programa tiene el objetivo de generar una matriz 1xM a partir de 
la funcion mem_din donde reserva memoria dinamica para guardar valores
dados por el usuario en un array. Dichos valores
representan posiciones de la matriz 1xM y escoge el mayor
numero para crear las columnas, donde columnas es el valor M
y con ello la matriz 1xM. Por ultimo agarra la direccion de
la fila del primer elemento (la unica fila) y se la imprime al usuario.
Los valores solicitados fueron solicitados por la funcion main que se creo
con la intencion de facilitarle la tarea de evaluacion al profesor.
*/
